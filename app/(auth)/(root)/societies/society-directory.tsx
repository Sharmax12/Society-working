  ...
  return <>
    <section className="relative overflow-hidden border-b border-foreground/10 surface-grid">
      ...
      <div className="relative mx-auto max-w-7xl px-5 pb-16 pt-14 sm:px-8 lg:px-10 lg:pt-20">
        ...
        <div className="mt-5 grid gap-10 lg:grid-cols-[1fr_420px] lg:items-end">
          <div><h1 className="text-5xl text-black dark:text-white font-black tracking-tight text-neutral-900"> Find your{' '}<span className="bg-gradient-to-r from-violet-600 via-fuchsia-500 to-amber-500 bg-clip-text text-transparent">people.</span> </h1><p className="mt-5 max-w-xl text-base leading-7 text-muted-foreground">Not sure where you fit yet? Take a look around. There&apos;s probably a room, team, stage, lab, or late-night idea waiting for you.</p></div>
    ...
    <div className="mx-auto max-w-7xl px-5 py-12 sm:px-8 lg:px-10">
      <div className="mb-7 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        <div><p className="text-xs font-black uppercase tracking-[.18em] text-primary">EXPLORE CLUBS</p><h2 className="mt-1 text-2xl font-black tracking-tight">Communities on campus</h2><p className="mt-1 text-sm text-muted-foreground">Find your next thing or revisit a society whose applications have wrapped up.</p></div>
